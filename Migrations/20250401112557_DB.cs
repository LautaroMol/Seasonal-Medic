        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDebitDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Abonos_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovimientosAbonos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovimientosAbonos_Abonos_AbonoId",
                        column: x => x.AbonoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimientosAbonos_AbonoId",
